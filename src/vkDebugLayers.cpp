    ...
    if (callbackData->objectCount > 0)
    {
        ...
        for (uint32_t object = 0; object < callbackData->objectCount; ++object)
        {
            ss << " Object[" << object << "] - Type "
                << debugAnnotObjectToString(callbackData->pObjects[object].objectType)
...
VkResult vkDebugAndExtensions::createDebugUtilsMessengerEXT(VkInstance instance,
...
void vkDebugAndExtensions::destroyDebugUtilsMessengerEXT(
    VkInstance instance,
